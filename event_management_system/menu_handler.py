...
class MenuHandler:
    ...
    def __init__(self, user_service, event_service,  registration_repository):
    ...
    def run(self):
        ...
        while True:
            ...
            elif self.current_user.role == UserRole.PARTICIPANT.value:
    ...
    def _login(self):
        ...
        try:
            user = self.user_service.login(email.lower()) #logs in the user
